...
public final class CONSTANT {
    public static final Color defaultChessBoardColor = new Color(236, 207, 105);
    ...
    public static ImageIcon getImageIcon(String imageName) {
        InputStream inputStream = CONSTANT.class.getClassLoader().getResourceAsStream("resources/" + imageName);
        try {
